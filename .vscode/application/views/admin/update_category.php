	...
	<div class="container-fluid px-2">
		...
		<div class="card mb-2">
			...
			<h1>Update danh mục <?=$object->name?></h1>
				...
				<form method="post" action="/admin/category/edit?id=<?=$object->id?>">
					<div class="form-group">
						<label for="category_name">Tên danh mục</label>
						<input type="text" class="form-control" id="category_name" name="category_name" value='<?=$object->name?>' placeholder="Nhập tên danh mục">
					</div>
