(function() {
    ...
    var supportedBrushes = [{ name: "HTML", brush: "html" },
        { name: "CSS", brush: "css" },
        ...
        init: function(editor) {
            ...
            editor.ui.addComboButton("mdn-syntaxhighlighter", {
                ...
                panel: {
                    ...
                    attributes: {
                        "aria-label": gettext("Syntax Highlighter")
                    }
                },
                ...
                onRender: function() {
                    // When the selection changes, update my state so only PRE elements can bechosen
                    var self = this;
                    editor.on("selectionChange", function(event) {
                        var state = CKEDITOR.TRISTATE_DISABLED,
                            element = event.data.path.block != null && event.data.path.block.$;
