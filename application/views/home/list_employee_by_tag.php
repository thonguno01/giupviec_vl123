...
<div class="main_content">
	...
	<div class="address_bar address_bar_pc">
		...
		<span class="link_grey"><a href="/tim-giup-viec-gvt0c0d0.html">Tìm người giúp việc</a></span>
	</div>
							...
							<div class="box_profile">
								<div class="box_left">
									<a href="<?= rewrite_employee_link($employee['alias'], $employee['id']) ?>">
										<div class="avt">
											<? if ($employee['image']) { ?>
												<img data-src="<?= rewirte_user_img_href($employee['id'], $employee['image']) ?>" src="/images/lazy_load.gif" alt="anh dai dien">
											<? } else { ?>
												<img data-src="/images/employee_ava.png" src="/images/lazy_load.gif" alt="anh dai dien">
											<? } ?>
										</div>
									</a>
									<div class="rate_star">
								...
								<div class="box_right">
									<a href="<?= rewrite_employee_link($employee['alias'], $employee['id']) ?>" class="name">
									<?= $employee['name'] ?>
									...
									<div class="info">
										...
										<div class="row_info">
											<div class="schedule">
											<div class="<? if ($employee['t2_ca1_bd']) echo 'active';
												else echo 'non_active' ?>">T2</div>
											<div class="<? if ($employee['t3_ca1_bd']) echo 'active';
												else echo 'non_active' ?>">T3</div>
												<div class="<? if ($employee['t4_ca1_bd']) echo 'active';
												else echo 'non_active' ?>">T4</div>
												<div class="<? if ($employee['t5_ca1_bd']) echo 'active';
												else echo 'non_active' ?>">T5</div>
												<div class="<? if ($employee['t6_ca1_bd']) echo 'active';
												else echo 'non_active' ?>">T6</div>
												<div class="<? if ($employee['t7_ca1_bd']) echo 'active';
												else echo 'non_active' ?>">T7</div>
												<div class="<? if ($employee['t8_ca1_bd']) echo 'active';
												else echo 'non_active' ?>">CN</div>
	...
	<div class="flex justyfy-between post">
            ...
            <div class="siderbar_muc_luc block_right">
