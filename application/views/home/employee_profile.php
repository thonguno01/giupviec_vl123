    ...
    <div id="wrap-content">
    	<div class="main_content">
    		<div class="bar_address  flex">
    			...
    			<span class="slug_none_1"><a class="active" href="">Trang cá nhân</a></span>
    		</div>
    	</div>
    	<div id="wr-content">
    		<!-- BOX-LEFT    -->
    		...
    		<div class="box-1 ">
    			...
    			<div class="info">
    				...
    				<span class="name_helper"><?= $employee['name'] ?></span>
    			...
    			<div class="top">
    				...
    				<div class="contact">
    					<div class="mail flex">
    						...
    						<p class="name_email"><?=$employee['email']; ?></p>
    					</div>
    					<div class="phone flex">
    						<img src="/images/helper_detail/phone.svg" alt="Số điện thoại">
    						<p class="sdt">SĐT:</p>
    						<p class="number_phone"><?=$employee['phone']; ?></p>
    					</div>
    				</div>
    			</div>
							...
							foreach ($employee_rate as $rate) { ?>
    							<div class="item">
    								<div class="container flex">
    									<div class="image">
    										<img src="/images/helper_detail/avat_user.png" alt="">
    									</div>
