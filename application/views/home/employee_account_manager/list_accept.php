...
<div class="main_content">
	<div class="box_left">
		...
		<div class="menu_manager">
			...
			<button id="job_accept" class="active">Công việc đã được chấp nhận</button>
...
<<<<<<< HEAD
						<div class="job_status">
								<button class="change_job_status">
									<?
									switch ($job['work_status']) {
										case '1':
											echo '<span class="text working">Đang làm</span>';
											break;
										case '2':
											echo '<span class="text end">Kết thúc</span>';
											break;
										default:
								...
								<div class="menu_status" style="display: none;" id="<?=$job['id']?>">
									<button class="not_start <? if ($job['work_status'] == 0) echo 'selected' ?>" value="0">Chưa bắt đầu</button>
									<button class="working <? if ($job['work_status'] == 1) echo 'selected' ?>" value="1">Đang làm</button>
									<button class="done <? if ($job['work_status'] == 2) echo 'selected' ?>" value="2">Kết thúc</button>
								</div>
							</div>
								</div>
					<?}?> 
=======
						<?if($job['work_status']==0){?>
							<div class="job_status">
							<button class="change_job_status">
