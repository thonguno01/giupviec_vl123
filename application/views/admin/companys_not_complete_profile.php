...
<div class="content-wrapper">
    <section class="content-header">
         ...
         <h1>
            ...
            <small> Người thuê giúp việc chưa hoàn thiện hồ sơ</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/admin/list_ntd"><i class="fa fa-dashboard"></i>Quản lý thuê giúp việc</a></li>
            <li><a href="/admin/list_ntd">Danh sách</a></li>
        </ol>
    </section>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
				...
				<form method="GET" action="/admin/search_company_not_complete_profile">
                            ...
                            <? if(!empty($list_company)){
                                ...
                                foreach($list_company as $list){ ?>  
                                     <tr>
                                        ...
                                        <td >
                                            <? echo date('d-m-Y', $list['update_at']) ?>
                                        </td>
										<td>
										<a href="/admin/register_for_company/<?=$list['profile_id']?>">
