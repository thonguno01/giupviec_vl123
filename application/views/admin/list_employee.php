        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body ">
					<form method="GET" action="/admin/search_employee">
                                ...
                                foreach($list_employee as $list){ ?>  
                                    <tr>
                                        ...
                                        <td style="">
                                            <? echo $list['name'] ?>
                                            <br>
                                            <a href="<? echo rewrite_employee_link($list['alias'], $list['id']) ?>" target="_blank"><? echo rewrite_employee_link($list['alias'], $list['id']) ?>
                                        </td>
                                        <td style=""></a>
                                            <? echo $list['email'] ?>
                                        </td>
                                        ...
                                        <td class="form-group">
                                            <a href="/admin/update_employee/<? echo $list['id'] ?>" class="btn btn-primary" style="padding: 4px 6px;"><i class="glyphicon glyphicon-pencil"></i></a>
                                        </td>
                                    </tr>
                                <?}
                            }?>
