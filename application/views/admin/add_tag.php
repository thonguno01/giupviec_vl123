                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group t-form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="content" placeholder="Nhập nôi dung">
                                                    <span class="form-message"></span>
                                                </div>
                                                <div class="form-group t-form-group">
                                                <label for="">Mô tả<span>*</span></label>
                                                    <textarea class="form-control" name="description" placeholder="Nhập mô tả " rows="5" cols="25"></textarea>
                                                    <span class="form-message"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                         ...
                                         <div class="infor-tt text-center">
                                            <button class="btn btn_reg1 click_add_tutor" type="submit" name="add_tutor">Thêm mới</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
