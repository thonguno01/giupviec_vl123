<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Bài viết tags việc làm
            <small>Danh sách</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="list_post_tag.php"><i class="fa fa-dashboard"></i>Bài viết tags việc làm</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body ">
					<form method="GET" action="search_tag_job">
                        ...
                        <table data-toolbar="#toolbar" data-toggle="table" class="table table-hover">
                            ...
                            <? if(!empty($list_post)){
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <a href="<?=rewrite_tag_job_link($row['alias'],$row['id'])?>" class="t_city_item" target="_blank"><?=base_url().rewrite_tag_job_link($row['alias'],$row['id'])?></a>
                                    </td>
