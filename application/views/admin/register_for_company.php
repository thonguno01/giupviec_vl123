...
<div class="content-wrapper">
    <section class="content-header">
         ...
         <h1>
            ...
            <small> Hoàn thiện hồ sơ người thuê giúp việc</small>
        </h1>
        <ol class="breadcrumb">
			...
			<div class="form_input">
				<div class="row">
					<div class="left">
						...
						<input type="text" name="email" id="email" placeholder="Nhập địa chỉ email" value="<?=$company['user_email']?>" disabled>
					...
					<div class="right">
						...
						<input type="text" name="phone" id="phone" placeholder="Nhập số điện thoại" value="<?=$company['user_phone']?>">
				...
				<div class="row">
					<div class="left">
						...
						<input type="text" name="name" id="name" placeholder="Nhập họ và tên" value="<?=$company['user_name']?>">
					...
					<div class="right">
						...
						<input type="date" name="birth" id="birth" value="<?if($company['user_birthday']) echo date('Y-m-d',$company['user_birthday'])?>">
						...
						<select name="province" id="province">
							...
							<?
									foreach($list_city as $city){
										if($city['cit_id']==$company['user_city_id']){
				...
				<div class="row">
					<div class="center">
						...
						<input type="text" name="address" id="address" placeholder="Nhập địa chỉ cụ thể" value="<?=$company['user_address']?>">
