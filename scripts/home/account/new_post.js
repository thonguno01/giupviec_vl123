    ...
    if (form_post_validate()) {
        ...
        $.ajax({
            ...
            success: function(output) {
                ...
                } else if (output['title_exist']) {
                    alert('Tiêu đề đã tồn tại!');
                } else if (!output['time_check']) {
                    alert('Mỗi bài đăng phải cách nhau 10 phút!');
                } else if (!output['number_new_check']) {
                    alert('Số tin đăng không quá 24 tin/ngày!');
                } else if (output['post_exist']) {
